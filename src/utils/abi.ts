...
export const billboardRegistryAbi = [
  ...
  {
    inputs: [{ internalType: "string", name: "type_", type: "string" }],
    name: "Unauthorized",
    type: "error",
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint64", name: "endAt", type: "uint64" },
    ],
    name: "AuctionCreated",
    type: "event",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint64", name: "leaseStartAt_", type: "uint64" },
      { internalType: "uint64", name: "leaseEndAt_", type: "uint64" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "tax_", type: "uint256" },
    ],
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "tokenId_", type: "uint256" },
      { internalType: "uint64", name: "startAt_", type: "uint64" },
      { internalType: "uint64", name: "endAt_", type: "uint64" },
    ],
    name: "newAuction",
    outputs: [
      { internalType: "uint256", name: "newAuctionId", type: "uint256" },
    ],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "auctionId_", type: "uint256" },
      { internalType: "address", name: "bidder_", type: "address" },
      { internalType: "bool", name: "isWithdrawn_", type: "bool" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "auctionId_", type: "uint256" },
      { internalType: "address", name: "bidder_", type: "address" },
      { internalType: "bool", name: "isWon_", type: "bool" },
    ],
    name: "setBidWon",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "owner_", type: "address" },
      { internalType: "uint256", name: "accumulated_", type: "uint256" },
      { internalType: "uint256", name: "withdrawn_", type: "uint256" },
    ],
    name: "setTaxTreasury",
    outputs: [],
    stateMutability: "nonpayable",
